...
sale table example
   TransactionID,CustomerID,ProductID,SaleDate,SaleAmount
...
Day,ProductID,CustomerID,SaleAmount,SaleIDCount,SaleIDs
...
def main():
    ...
    sales_df["Day"] = sales_df["SaleDate"].dt.day_name()
    ...
    dimensions = ["Day", "ProductID", "CustomerID"]
    metrics = {
        "SaleAmount": ["sum", "mean"],
        "TransactionID": "count"
    }
