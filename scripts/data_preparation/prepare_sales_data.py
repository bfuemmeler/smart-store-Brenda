...
input_file = r"c:/PROJECTS/smart-store-Brenda\data\raw\sales_data.csv"
cleaned_file = r"c:/PROJECTS/smart-store-Brenda\data\prepared\sales_data_prepared.csv"

# Expected schema: {column_name: data_type}
expected_schema = {
    "TransactionID": "int64",
    "SaleDate": "object",   # 'object' is the dtype for strings in pandas
    "CustomerID": "int64",
    "ProductID": "int64",
    "StoreID": "int64",
    "CampaignID": "int64",
...
numeric_columns = ["TransactionID", "CustomerID", "ProductID", "StoreID", "CampaignID", "SaleAmount", "BonusPoints"]  # Specify numeric columns to check
